...
public:
    ...
    friend void GetPacket(const unsigned char* packetdata,const unsigned packetlen, void* userdata);
};
...
public:
    ...
    AcceptClient(TcpClientCtx* control, int clientid, uv_loop_t* loop);
